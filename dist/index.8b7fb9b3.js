...
const initialState = [
    {
        name: "democracy",
        date: new Date(2021, 8, 16).toDateString(),
    ...
    },
    {
        ...
        intro: "Na de zomer van 2021 waarin West-Europa overstroomde, hitterecords de VS en Canada verschroeiden en Zuid-Europa door bosbranden in de as werd gelegd, stellen we ons de vraag: valt het klimaat nog te redden, of komen alle beloftes van de wereldleiders rijkelijk te laat?",
