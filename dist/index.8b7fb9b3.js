...
var _reduxLoggerDefault = parcelHelpers.interopDefault(_reduxLogger);
...
exports.default = _redux.createStore(rootReducer, _reduxDevtoolsExtension.composeWithDevTools(_redux.applyMiddleware(_reduxLoggerDefault.default)));
const likesStore = _redux.createStore(_likesDefault.default);

},{"redux":"ifMRI","./news":"fJgQd","./music":"fs6CZ","./photos":"6iDTk","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV","./likes":"LSTUt","redux-devtools-extension":"fbbZr","redux-logger":"djYmw"}],"ifMRI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
 ...
 * INITIAL DATA
 */ const initialState = [
    new _newsitemDefault.default("democracy", new Date(2021, 8, 16), "Poll Finds Most Americans Would Swap Democracy For $100 Best Buy Gift Card", "According to the results of a new poll released Thursday by the Pew Research Center, the majority of Americans would swap democracy for a $100 Best Buy gift card.", "https://www.theonion.com/poll-finds-most-americans-would-swap-democracy-for-100-1847682668"),
    new _newsitemDefault.default("luchtbalonnen", new Date(2021, 9, 3), "Honderden luchtballonnen stijgen op tijdens festival in VS", "Honderden ballonnen stegen zaterdag op in Albuquerque, in alle denkbare kleuren, vormen en maten. In de Amerikaanse stad is zaterdag het internationale luchtballonfestival van start gegaan.", "https://www.standaard.be/cnt/dmf20211003_93538427"),
    new _newsitemDefault.default("alligator", new Date(2021, 9, 2), "Man ziet alligator in tuin en grijpt op hoogst originele wijze in", "Een man in Florida heeft op spectaculaire wijze een alligator kunnen vangen. Het reptiel verschool zich in de tuin van de buren, maar Abdul Gene Malik vond een oplossing om het dier te vangen. ", "https://www.standaard.be/cnt/dmf20211002_93599532"),
    new _newsitemDefault.default("klimaat", new Date(2021, 9, 24), "Nog één week voor de klimaattop: hoe zit het nu eigenlijk met onze planeet?", "Na de zomer van 2021 stellen we ons de vraag: valt het klimaat nog te redden, of komen alle beloftes van de wereldleiders rijkelijk te laat?", "https://www.standaard.be/cnt/dmf20211022_94506296"),
    new _newsitemDefault.default("zeespiegel", new Date(2021, 9, 15), "Dreiging voor steden als zeespiegel jaren blijft stijgen", "Als de opwarming van de aarde in het huidige tempo doorgaat, moeten zo’n vijftig steden ‘ongekende aanpassingsmaatregelen’ nemen om te voorkomen dat ze door stijgend waterpeil onder water komen te staan.", "https://www.standaard.be/cnt/dmf20211015_93918618"), 
];
/**
 * REDUCER
...
},{"../components/newsitem":"ie6yB","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"ie6yB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../components/song":"dpBmu","f05dabcd18bc6e23":"8mUG8","1ab89ed192bafe4b":"aYSjE","8ffa39f285ce86c6":"46MSr","942d5e2dc826489":"c3BZv","e845d0cef57403cf":"6Lw9F","ebcd0aa0863af56d":"hlaSN","a5ac90bdc993c624":"hY6AB","28dc058371e7c750":"d3N4D","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"dpBmu":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../components/photo":"1Hh7W","676d6bcd1a6ee56d":"2U0mM","2b52d4b06755bc02":"lnyNm","8cd1004c19adfabf":"1Kayb","ce7d915acbc4fc3":"lCtaX","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"1Hh7W":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"fbbZr":[function(require,module,exports) {
'use strict';
...
},{"redux":"ifMRI"}],"djYmw":[function(require,module,exports) {
...
!function(e, t) {
    ...
    function d(e, t, r) {
        if (e && t && r && r.kind) {
            for(var n = e, o = -1, i = r.path ? r.path.length - 1 : 0; ++o < i;)"undefined" == typeof n[r.path[o]] && (n[r.path[o]] = "number" == typeof r.path[o] ? [] : {
            }), n = n[r.path[o]];
            switch(r.kind){
                case "A":
    ...
    function g(e, t, r) {
        if (e && t && r && r.kind) {
            var n, o, i = e;
            for(o = r.path.length - 1, n = 0; n < o; n++)"undefined" == typeof i[r.path[n]] && (i[r.path[n]] = {
            }), i = i[r.path[n]];
            switch(r.kind){
                case "A":
    ...
    function S() {
        ...
        }, L, e3), r = t.logger, n = t.stateTransformer, o = t.errorTransformer, i = t.predicate, a = t.logErrors, f = t.diffPredicate;
        ...
        if (e3.getState && e3.dispatch) return console.error("[redux-logger] redux-logger not installed. Make sure to pass logger instance as middleware:\n// Logger with default options\nimport { logger } from 'redux-logger'\nconst store = createStore(\n  reducer,\n  applyMiddleware(logger)\n)\n// Or you can create your own logger with custom options http://bit.ly/redux-logger-options\nimport createLogger from 'redux-logger'\nconst logger = createLogger({\n  // ...options\n});\nconst store = createStore(\n  reducer,\n  applyMiddleware(logger)\n)\n"), function() {
            return function(e) {
                return function(t) {
                    return e(t);
                };
    ...
    k = "object" === ("undefined" == typeof global ? "undefined" : N(global)) && global ? global : "undefined" != typeof window ? window : {
    }, j = k.DeepDiff, j && C.push(function() {
    ...
    var F = {
        ...
        }, t = e.dispatch, r = e.getState;
        return "function" == typeof t || "function" == typeof r ? S()({
            dispatch: t,
            getState: r
        }) : void console.error("\n[redux-logger v3] BREAKING CHANGE\n[redux-logger v3] Since 3.0.0 redux-logger exports by default logger with default settings.\n[redux-logger v3] Change\n[redux-logger v3] import createLogger from 'redux-logger'\n[redux-logger v3] to\n[redux-logger v3] import { createLogger } from 'redux-logger'\n");
    };
    e4.defaults = L, e4.createLogger = S, e4.logger = T, e4.default = T, Object.defineProperty(e4, "__esModule", {
        value: !0
    });
});
